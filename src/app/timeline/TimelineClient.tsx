          ...
          <div ref={scrollRef} className="overflow-x-auto">
            <div className="flex min-w-max">
              {monthGroups.map((group, groupIdx) => (
                ...
                >
                  {/* Month header */}
                  <div className="sticky top-0 z-10 bg-muted/50 border-b border-border px-4 py-3">
                    ...
                    {group.bills.map((bill) => {
                      ...
                      return (
                        <motion.div
                          ...
                          variants={fadeUp}
                          className="group cursor-pointer rounded-lg border border-border bg-card p-3 transition-all duration-200 hover:border-primary/30 hover:shadow-sm"
                          onClick={() =>
            ...
            <div className="space-y-2">
              {group.bills.map((bill) => {
                ...
                return (
                  <div
                    key={bill.parliamentId}
                    className="rounded-lg border border-border bg-card p-3 cursor-pointer transition-all hover:bg-accent"
